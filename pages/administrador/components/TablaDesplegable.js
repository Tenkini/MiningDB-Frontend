  ...
  return (
    <>
      {datos.map((rajo, rajoIndex) => {
        ...
        return (
          <div
            className={`overflow-x-auto text-left bg-MainLight dark:bg-MainDark border border-separate border-spacing-0 border-BorderLight dark:border-BorderDark rounded-3xl mb-10 mx-4 shadow-[0px_0px_15px_rgba(114,114,113,0.3)] '`}
          >
            <table
              className="table-auto text-TextLight dark:text-TextDark w-full"
              key={rajoIndex}
            >
              <thead>
                <tr>
                  ...
                  <th className="p-2 border-b border-custom-gray">
                    Diario Real
                  </th>
                  <th className="p-2 border-b border-custom-gray">
                    Diario Plan
              ...
              <tbody>
                <tr>
                  <td>
                    <button
                      className={`flex items-center justify-center w-10 h-10 expand-button ${
                        isRajoExpanded ? "expanded" : ""
                      } `}
                      onClick={() => toggleRow(rajoIndex)}
                    >
                      {isRajoExpanded ? (
                        <BiMinusCircle className="w-6 h-6" />
                      ) : (
                ...
                {isRajoExpanded &&
                  rajo.fases.map((fase, faseIndex) => {
                    const isFaseExpanded = expandedRows.includes(
                      `${rajoIndex}-${faseIndex}`
                    );
                        ...
                        <tr className={`${rowAnimationClass}`}>
                          ...
                          <td className="border-t border-custom-gray">
                            <div className="flex items-center justify-center h-full">
                              <button
                                className={`flex items-center justify-center w-10 h-10 expand-button ${
                                  isFaseExpanded ? "expanded" : ""
                                }`}
                                onClick={() =>
                                  toggleRow(`${rajoIndex}-${faseIndex}`)
                                }
                              >
                                {isFaseExpanded ? (
                                  <BiMinusCircle className="w-6 h-6" />
                          ...
                          <td className="border-t border-custom-gray"></td>
                          <td className="p-2 border-t border-custom-gray">
                            {fase.DiarioReal}
                          </td>
                          <td className="p-2 border-t border-custom-gray">
                            {fase.DiarioPlan}
                          ...
                          <td className="p-2 border-t border-custom-gray">
                            {fase.KPI === 0 ? renderRedCircle() : null}
                          </td>
                          <td className="p-2 border-t border-custom-gray">
                            {fase.SemanalISOReal}
                          </td>
                          ...
                          <td className="p-2 border-t border-custom-gray">
                            {fase.KPI2 === 0 ? renderRedCircle() : null}
                          </td>
                          <td className="p-2 border-t border-custom-gray">
                            {fase.SemanalReal}
                          </td>
                          ...
                          <td className="p-2 border-t border-custom-gray">
                            {fase.KPI3 === 0 ? renderRedCircle() : null}
                          </td>
                          <td className="p-2 border-t border-custom-gray">
                            {fase.MensualReal}
                          </td>
                          ...
                          <td className="p-2 border-t border-custom-gray">
                            {fase.KPI4 === 0 ? renderRedCircle() : null}
                          </td>
                          <td className="p-2 border-t border-custom-gray">
                            {fase.AnualReal}
                          </td>
                          ...
                          <td className="p-2 border-t border-custom-gray">
                            {fase.KPI5 === 0 ? renderRedCircle() : null}
                          </td>
                        </tr>
                        {isFaseExpanded &&
                          fase.flotas.map((flota, flotaIndex) => (
                            ...
                            >
                              ...
                              <td className="p-2 border-t border-custom-gray">
                                {flota.KPI === 0 ? renderRedCircle() : null}
                              </td>
                              <td className="p-2 border-t border-custom-gray">
                                {flota.SemanalISOReal}
                              </td>
                              <td className="p-2 border-t border-custom-gray">
                                {flota.SemanalISOPlan}
                              </td>
                              <td className="p-2 border-t border-custom-gray">
                                {flota.KPI2 === 0 ? renderRedCircle() : null}
                              </td>
                              <td className="p-2 border-t border-custom-gray">
                                {flota.SemanalReal}
                              </td>
                              ...
                              <td className="p-2 border-t border-custom-gray">
                                {flota.KPI3 === 0 ? renderRedCircle() : null}
                              </td>
                              <td className="p-2 border-t border-custom-gray">
                                {flota.MensualReal}
                              </td>
                              ...
                              <td className="p-2 border-t border-custom-gray">
                                {flota.KPI4 === 0 ? renderRedCircle() : null}
                              </td>
                              <td className="p-2 border-t border-custom-gray">
                                {flota.AnualReal}
                              </td>
                              ...
                              <td className="p-2 border-t border-custom-gray">
                                {flota.KPI5 === 0 ? renderRedCircle() : null}
                              </td>
                            </tr>
                          ))}
                      </React.Fragment>
