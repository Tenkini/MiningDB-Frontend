          ...
          <div className="bg-MainLight dark:bg-MainDark rounded p-8 max-w-lg">
            ...
            <div className="mb-8"> 
              ...
              <Autocomplete
                ...
                sx={{
                  width: '100%',
                  minWidth: '300px', // Ajusta el ancho mínimo según tus necesidades
                  minHeight: '48px',
                }}
              />
            </div>
            ...
            <div className="mb-8"> 
              <label className="block font-bold mb-2">Flota</label>
              <Autocomplete
                multiple
            ...
            <LocalizationProvider dateAdapter={AdapterDayjs}>
                ...
                <DatePicker value={value} onChange={(newValue) => setValue(newValue)} sx={{
                  width: '100%',
                  minWidth: '300px', // Ajusta el ancho mínimo según tus necesidades
                  minHeight: '48px',
                }}/>
